        ...
        <div class="flex flex-col justify-between w-full overflow-auto md:h-full h-svh pt-4 pb-2.5">
            <div class="relative flex flex-col">
                ...
                <div
                    ...
                    <x-app.sidebar-link href="/dashboard" icon="phosphor-house" :active="Request::is('dashboard')">
                        Dashboard
                    </x-app.sidebar-link>
                    <x-app.sidebar-link href="{{ route('properties.index') }}" icon="phosphor-building-apartment"
                                        :active="Request::routeIs('properties.*')">Properties
                    </x-app.sidebar-link>
                    <x-app.sidebar-link href="{{ route('professions.index') }}" icon="phosphor-briefcase"
                                        :active="Request::routeIs('professions.*')">Professions
                    </x-app.sidebar-link>
            ...
            <div class="relative px-2.5 space-y-1.5 text-zinc-700 dark:text-zinc-400">
                ...
                {{--                <x-app.sidebar-link href="#" target="_blank" icon="phosphor-book-bookmark-duotone" active="false">Documentation</x-app.sidebar-link>--}}
                {{--                <x-app.sidebar-link href="#" target="_blank" icon="phosphor-chat-duotone" active="false">Questions</x-app.sidebar-link>--}}
